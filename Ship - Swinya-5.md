...
* Crisis:	-
### Resources
- Maximum Hardpoints: 2 - Hull 2
- Used Hardpoints: Multifocal Laser 1, Sandthrower 1
- Maximum Power: 14 - Hull 10, Power Trunk Streamlining 4
- Used Power: 13 - Spike-Drive-2 2, Multifocal Laser 5, Sandthrower 3, Fuel Scoots 2, Workshop 1
- Maximum Mass: 15 - Hull 15
...
| Cost | Speed | Armor | HP  | Crew | AC  | Power | Mass | Hard. | Class   |
| ---- | ----- | ----- | --- | ---- | --- | ----- | ---- | ----- | ------- |
| 500k | 3     | 2     | 20  | 1/6  | 14  | 10    | 15   | 2     | Frigate |
### Weapon: Multifocal Laser

| Cost | Dmg | Power | Mass | Hard. | Class    | TL  | Qualities |
| ---- | --- | ----- | ---- | ----- | -------- | --- | --------- |
...
### Fitting: Spike-Drive 2
Cost 100k - Power 2 - Mass 2
* Time per hex: 3 Days
* Hex per jump: 2
### Fitting: Cargo Space
Cost 0 - Power 0 - Mass X
Gain 20 Tons cargo space per unused Mass.
### Fitting: Atmospheric Configuration
Cost 50k - Power 0 - Mass 2
Able to enter atmosphere and land. Equipped with landing gear, stabilizers, and an aerodynamic hull.
### Fitting: Fuel Scoops
Cost 50k - Power 2 - Mass 2
Able to gather fuel from compatible solar bodies and gas giants. Requires 4 days per 1 unit of fuel.
### Fitting: Fuel Bunker
Cost 25k - Power 0 - Mass 1
Can store 1 additional fuel.
### Fitting: Workshop
Cost 5k - Power 1 - Mass 1
A frigate-sized workshop is sufficient for modding any personal gear as per the modification rules on page 100.
...
Cost 20k - Component 1
Trade X Mass for X times 2 Power.
Traded: 2 Mass for 4 Power
### Modification: Emergency Thruster Boost
Cost 20k
Once per space combat, gain a +2 bonus to Speed for three rounds.
